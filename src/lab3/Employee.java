...
public class Employee {
    ...
    private ReportService reportSrvice;
    ...
    public Employee(String firstName, String lastName, String ssn) {
        ...
        setSsn(ssn);
        reportSrvice = new ReportService();
    }
    ...
    private void meetWithHrForBenefitAndSalryInfo() {
        metWithHr = true;
        reportSrvice.printingReport(firstName + " " + lastName + " met with Hr on "
                + getFormattedDate());
    }
    ...
    private void meetDepartmentStaff() {
        metDeptStaff = true;
        reportSrvice.printingReport(firstName + " " + lastName + " met with Dept. Staff on "
                + getFormattedDate());
    }
    ...
    public void reviewDeptPolicies() {
        ...
        reportSrvice.printingReport(firstName + " " + lastName + " reviewed Dept policies on "
                + getFormattedDate());
    }
    ...
    public void moveIntoCubicle(String cubeId) {
        this.cubeId = cubeId;
        this.movedIn = true;
        reportSrvice.printingReport(firstName + " " + lastName + " moved into cubicle "
    ...
    public void setLastName(String lastName) {
        if (lastName == null || lastName.isEmpty()) {
            reportSrvice.printingReport("last name is required");
        }
    ...
    public void setSsn(String ssn) {
        if (ssn == null || ssn.length() < 9 || ssn.length() > 11) {
            reportSrvice.printingReport("ssn is required and must be "
    ...
    public void setCubeId(String cubeId) {
        if (cubeId == null || cubeId.isEmpty()) {
            reportSrvice.printingReport("cube id is required");
        }
        this.cubeId = cubeId;
    }
    ...
    public void setOrientationDate(Date orientationDate) {
        if (orientationDate == null) {
            reportSrvice.printingReport("orientationDate is required");
        }
